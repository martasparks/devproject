  ...
  useEffect(() => {
    const fetchCategoryData = async () => {
      ...
      setTimeout(() => {
        setCategory({
          id: '1',
          name: slug === 'akcijas' ? 'Akcijas' : slug === 'virtuve' ? 'Virtuve' : 'Kategorija',
          slug,
          children: []
        });
        ...
        setProducts([
          {
            id: '1',
            name: 'Premium virtuves galds ar marmora virsmu',
            price: 299.99,
          ...
          {
            id: '2',
            name: 'Mūsdienīgs krēsls ar ergonomisku dizainu',
            price: 159.99,
            image: '/images/product-placeholder.jpg',
            rating: 4.8,
            reviewCount: 156,
          ...
          {
            id: '3',
            name: 'Dizaina lampa ar LED apgaismojumu',
            price: 89.99,
          ...
          {
            id: '4',
            name: 'Plašs virtuves skapītis ar stikla durvīm',
            price: 449.99,
            image: '/images/product-placeholder.jpg',
            rating: 4.6,
            reviewCount: 72,
      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between mb-8">
          <div>
            ...
            <p className="text-gray-600">{products.length} produkti</p>
          </div>
          ...
          <div className="flex items-center space-x-4 mt-4 md:mt-0">
            ...
            >
              ...
              <option value="price-low">Cena: zemāka → augstāka</option>
              <option value="price-high">Cena: augstāka → zemāka</option>
